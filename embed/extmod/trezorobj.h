...
// Converts int object into mp_int_t, without any conversions. Raises if object
// is not int or if it does not fit into mp_int_t representation.
...
// Converts int object into mp_uint_t, without any conversions. Raises if object
// is not int or if it does not fit into mp_uint_t representation (or is less
// than 0).
