...
class TxOutputType(p.MessageType):
    ...
    def __init__(
        ...
        self.block_hash_bip115 = default_block_hash if block_hash_bip115 is None else block_hash_bip115
        self.block_height_bip115 = default_block_height if block_height_bip115 is None else block_height_bip115
